...
import { defineComponent, shallowRef, computed, ref, watchEffect, watch, onMounted, nextTick, onBeforeUnmount, unref, markRaw, createApp, useSSRContext } from "vue";
...
import { v as computedAsync, x as useSessionStorage, y as useLocalStorage, z as watchDebounced, e as onKeyStroke, r as useRouter, A as useEventListener, j as useScrollLock, n as dataSymbol, p as pathToFile, h as inBrowser, B as escapeRegExp } from "./Content.VGHLru3x.js";
...
const localSearchIndex = { "root": () => import("./@localSearchIndexroot.DCg3qpRM.js"), "fr": () => import("./@localSearchIndexfr.n8nPTy8S.js") };
class LRUCache {
  constructor(max = 10) {
