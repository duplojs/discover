import { getCurrentInstance, hasInjectionContext, inject, watch, getCurrentScope, onScopeDispose, onMounted, nextTick, isRef, toValue, toRef as toRef$1, readonly, customRef, ref, shallowRef, watchEffect, computed, unref, reactive, onUnmounted, markRaw, defineComponent, h } from "vue";
function deserializeFunctions(r) {
  return Array.isArray(r) ? r.map(deserializeFunctions) : typeof r == "object" && r !== null ? Object.keys(r).reduce((t, n) => (t[n] = deserializeFunctions(r[n]), t), {}) : typeof r == "string" && r.startsWith("_vp-fn_") ? new Function(`return ${r.slice(7)}`)() : r;
}
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"DuploJS","description":"A VitePress site","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":false,"themeConfig":{"logo":"/images/logo.png","wip":{"title":"WIP","button":"Request this page"},"socialLinks":[{"icon":"github","link":"https://github.com/duplojs/discover"},{"icon":"npm","link":"https://www.npmjs.com/package/@duplojs/discover"},{"icon":"linkedin","link":"https://linkedin.com/company/duplojs"},{"icon":"discord","link":"https://discord.gg/5d6Ze5Wuqm"}],"search":{"provider":"local"}},"locales":{"fr":{"label":"Français","lang":"fr","link":"/fr/","themeConfig":{"nav":[],"sidebar":{},"docFooter":{"prev":"Page précédente","next":"Page suivante"},"outline":{"label":"Sur cette page"},"returnToTopLabel":"Retour en haut","darkModeSwitchLabel":"Mode sombre","footer":{"copyright":"Copyright © 2025-présent Contributeurs de DuploJS","message":"Diffusé sous licence MIT."}}},"root":{"label":"English","lang":"en","link":"/en/","themeConfig":{"nav":[],"sidebar":{},"docFooter":{"prev":"Previous page","next":"Next page"},"outline":{"label":"On this page"},"returnToTopLabel":"Return to top","darkModeSwitchLabel":"Dark mode","footer":{"copyright":"Copyright © 2025-present DuploJS contributors","message":"Released under the MIT License."}}}},"scrollOffset":134,"cleanUrls":true}'));
