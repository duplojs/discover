...
<template>
	<footer class="footer">
		<div class="container">
			<div class="footer__brand-row">
				<div class="footer__brand">
					...
					>
						...
						<span class="footer__logo-name">DuploJS</span>
					</a>
				...
				<div class="footer__social">
					...
					<a
						href="https://linkedin.com/company/duplojs"
						class="footer__social-link"
						aria-label="LinkedIn"
						target="_blank"
						rel="noopener"
			...
			<nav
				class="footer__grid"
				:aria-label="t.footer.colLearn"
			>
				<div class="footer__col">
					<span class="footer__col-label">{{ t.footer.colPackages }}</span>
				...
				<div class="footer__col">
					<span class="footer__col-label">{{ t.footer.colTooling }}</span>
				...
				<div class="footer__col">
					<span class="footer__col-label">{{ t.footer.colCommunity }}</span>
				...
				<div class="footer__col">
					<span class="footer__col-label">{{ t.footer.colLearn }}</span>
					...
					<a
						...
						target="_blank"
						rel="noopener"
					>{{ t.footer.apiReference }}</a>

					<a
						href="https://github.com/duplojs/http/releases"
						class="footer__link"
						target="_blank"
						rel="noopener"
					>{{ t.footer.changelog }}</a>
				</div>
			</nav>

			<div class="footer__bottom">
				<div class="footer__status-pills">
					<span class="footer__pill footer__pill--node"><span class="footer__pill-dot" />Node.js</span>
					<span class="footer__pill footer__pill--bun"><span class="footer__pill-dot" />Bun</span>
					<span class="footer__pill footer__pill--deno"><span class="footer__pill-dot" />Deno</span>
					<span class="footer__sep">&middot;</span>
					<span class="footer__badge">MIT License</span>
					<span class="footer__sep">&middot;</span>
					<span class="footer__badge">TypeScript-first</span>
				</div>
